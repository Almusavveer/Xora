            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                >
                  <div
                    className={clsx(
                      "small-2 rounded-20 relative z-2 mb-6  mx-auto border-2 px-4 py-1.5 uppercase",
                ...
                <div
                  className={clsx(
                    "body-1 relative z-2 mb-10 w-full border-s-s2 pb-9 text-center text-p4",
                    index !== 1 && "border-b border-s5"
                  )}
                >
                  {plan.caption}
                </div>
